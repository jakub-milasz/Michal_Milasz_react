    ...
    <>
      ...
      <main ref={mainRef}>
        <div className="cywilne">
          <h2>Prawo Cywilne</h2>
          <h3 className="suptitle">Wszechstronna pomoc w sprawach codziennych i majątkowych</h3>
          <p>
          ...
          <div className="row">
            <div className="col">
              <h3 className="header-with-line"><span>Nieruchomości i prawa konsumenta</span></h3>
              <p>
            ...
            <div className="col">
              <h3 className="header-with-line"><span>Rodzina, odszkodowania i dobra osobiste</span></h3>
              <p>
