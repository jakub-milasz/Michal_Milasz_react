    ...
    <>
      ...
      <main ref={mainRef}>
        <div className="gospodarcze">
          <h2>Kompleksowe wsparcie prawne dla biznesu</h2>
          <h3 className="suptitle">Od startu po rozwój</h3>
          <p>
          ...
          <div className="row">
            <div className="col">
              <h3 className="header-with-line"><span>Bezpieczeństwo umów i dokumentacji (RODO, E-commerce)</span></h3>
              <p>
            ...
            <div className="col">
              <h3 className="header-with-line"><span>Wsparcie na starcie – zakładanie działalności</span></h3>
              <p>
          ...
          <h3 className="header-with-line"><span>Reprezentacja sądowa</span></h3>
          <p>
